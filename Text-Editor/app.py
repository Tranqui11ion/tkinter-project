...
def show_about_info():
    about = messagebox.showinfo(title="About",
            message = "This Text Editor was created for educational purposes using Tkinter"
                               )
...
help_menu = tk.Menu(menubar, activebackground='purple')
...
help_menu.add_command(label='About', command=show_about_info, accelerator='Ctrl+H')
